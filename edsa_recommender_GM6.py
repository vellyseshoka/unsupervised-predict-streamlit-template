...
def main():
    ...
    #page_selection = option_menu (None, ["Home","Recommender System","Solution Overview","Exploratory Data Analysis","About"], 
    #icons=["house","gear", "list-task", "bar-chart-line","envelope"], 
    #menu_icon="cast", default_index=0, orientation="horizontal",
    #styles={
    #    "container": {"max-width" : "100%","padding": "0!important", "background-color": "#fafafa"},
        #"icon": {"color": "white", "font-size": "15px"}, 
    #    "nav-link": {"font-size": "15px", "text-align": "centre ", "margin":"-5px", "--hover-color": "#eee"},
    ...
    with st.sidebar:
        ...
        page_selection = option_menu (
			...
			menu_icon="list", 
			options = ["Home","Recommender System","Solution Overview","Exploratory Data Analysis","About"],
			icons = [ "house","gear", "list-task", "bar-chart-line","envelope"],
       )
